...
usage () {
    echo "Usage: $0 [OPTION]..."
    echo "Run netwroking-mlnx's coding check(s)"
    echo ""
    echo "  -Y, --pylint [<basecommit>] Run pylint check on the entire netwroking-mlnx module or just files changed in basecommit (e.g. HEAD~1)"
